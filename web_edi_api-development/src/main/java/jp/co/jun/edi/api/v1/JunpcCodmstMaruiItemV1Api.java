...
import jp.co.jun.edi.service.JunpcCodmstMaruiItemListService;
import jp.co.jun.edi.type.MCodmstTblIdType;

/**
 * 発注生産システムのコードマスタから丸井品番情報を取得するAPI.
 */
@RestController
@RequestMapping("/api/v1/junpc/codmst/maruiItems")
public class JunpcCodmstMaruiItemV1Api extends GenericJunpcCodmstV1Api {
    @Autowired
    private JunpcCodmstMaruiItemListService listService;

    /**
     * 発注生産システムのコードマスタから丸井品番情報をリストで取得する.
     *
    ...
    protected MCodmstTblIdType getTblId() {
        return MCodmstTblIdType.MARUI_ITEM;
    }

    @Override
    protected JunpcCodmstMaruiItemListService getListService() {
        return listService;
    }
}
