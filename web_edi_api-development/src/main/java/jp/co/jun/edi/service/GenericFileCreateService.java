 ...
 * @param <RESPONSE>
 */
public abstract class GenericFileCreateService<PARAMETER extends GenericServiceParameter, RESPONSE extends GenericServiceResponse> extends GenericService {
    /**
