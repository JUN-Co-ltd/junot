...
public enum SendCodeType {
     ...
     * @param value value
     */
    SendCodeType(final String value) {
        this.value = value;
    }
     ...
     */
    public static Optional<SendCodeType> findByValue(final String value) {
     ...
     * @return value
     */
    public static String convertToValue(final SendCodeType type) {
     ...
     * @return type
     */
    public static SendCodeType convertToType(final String value) {
     ...
     */
    @JsonCreator
    public static SendCodeType convertToJson(final String value) {
