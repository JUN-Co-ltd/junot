...
/**
 * 発注生産システムのコードマスタから原産国情報を取得するAPI.
 */
@RestController
@RequestMapping("/api/v1/junpc/codmst/originCountries")
public class JunpcCodmstOriginCountryV1Api extends GenericJunpcCodmstV1Api {
    @Autowired
    private JunpcCodmstSearchByTblIdListService listService;

    /**
     * 発注生産システムのコードマスタから原産国情報をリストで取得する.
     *
    ...
    protected MCodmstTblIdType getTblId() {
        return MCodmstTblIdType.ORIGIN_COUNTRY;
    }
