...
/**
 * 発注生産システムのコードマスタからサブブランド情報を取得するAPI.
 */
@RestController
@RequestMapping("/api/v1/junpc/codmst/subBrands")
public class JunpcCodmstSubBrandV1Api extends GenericJunpcCodmstV1Api {
    @Autowired
    private JunpcCodmstSearchByBrandListService listService;

    /**
     * 発注生産システムのコードマスタからサブブランド情報をリストで取得する.
     *
    ...
    protected MCodmstTblIdType getTblId() {
        return MCodmstTblIdType.SUB_BRAND;
    }
