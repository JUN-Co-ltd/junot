...
@Transactional
public class ScreenSettingV1Api_FukukitaruOrderWashName_Test {
    // モックサーバー
    @Autowired
    ...
    public void test_get_0001() throws Exception {
        ...
        model.setListMasterType(new ArrayList<ScreenSettingFukukitaruMasterType>() {
...

            {
                ...
                add(ScreenSettingFukukitaruMasterType.WASH_NAME);
            }
        });
        ...
        final MvcResult actual = mockServer
                .perform(MockMvcRequestBuilders.post("/api/v1/screenSettings/fukukitaru/orders/washName")
                        .with(csrf())
