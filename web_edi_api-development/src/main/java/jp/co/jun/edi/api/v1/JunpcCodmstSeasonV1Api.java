...
/**
 * 発注生産システムのコードマスタからシーズン情報を取得するAPI.
 */
@RestController
@RequestMapping("/api/v1/junpc/codmst/seasons")
public class JunpcCodmstSeasonV1Api extends GenericJunpcCodmstV1Api {
    @Autowired
    private JunpcCodmstSearchByTblIdListService listService;

    /**
     * 発注生産システムのコードマスタからシーズン情報をリストで取得する.
     *
    ...
    protected MCodmstTblIdType getTblId() {
        return MCodmstTblIdType.SEASON;
    }
