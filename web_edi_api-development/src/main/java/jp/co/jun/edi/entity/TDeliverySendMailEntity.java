...
/**
 * The persistent class for the t_delivery_send_mail database table.
 *
 */
@Entity
@Table(name = "t_delivery_send_mail")
@EntityListeners(AuditingEntityListener.class)
@Data
@EqualsAndHashCode(callSuper = true)
public class TDeliverySendMailEntity extends GenericEntity {
