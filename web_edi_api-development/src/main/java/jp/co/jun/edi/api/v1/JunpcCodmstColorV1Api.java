...
/**
 * 発注生産システムのコードマスタからカラー情報を取得するAPI.
 */
@RestController
@RequestMapping("/api/v1/junpc/codmst/colors")
public class JunpcCodmstColorV1Api extends GenericJunpcCodmstV1Api {
    @Autowired
    private JunpcCodmstColorListService listService;

    /**
     * 発注生産システムのコードマスタからカラー情報を一覧で取得する.
     *
