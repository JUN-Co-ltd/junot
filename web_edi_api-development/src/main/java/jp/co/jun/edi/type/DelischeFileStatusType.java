 ...
 * デリスケファイルステータスの分類.
 */
public enum DelischeFileStatusType {
    /** 作成中(0). */
    CREATING(0),
    /** 作成済(1). */
    COMPLETE_CREATE(1),
     ...
     * @param value value
     */
    DelischeFileStatusType(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<DelischeFileStatusType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final DelischeFileStatusType type) {
     ...
     * @return type
     */
    public static DelischeFileStatusType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static DelischeFileStatusType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
