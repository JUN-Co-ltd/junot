...
public class ExtendedTOrderEntity extends GenericEntity {
    ...
    private CompleteOrderType cutCompleteOrderType;
    ...
    private CompleteOrderType matlCompleteOrderType;

    /** 裁断済区分. */
    @Convert(converter = CompleteTypeConverter.class)
    @Column(name = "cut_complete_type")
    private CompleteType cutCompleteType;
    ...
    private CompleteType matlCompleteType;
    ...
    private ReissueType reissueFlg;
