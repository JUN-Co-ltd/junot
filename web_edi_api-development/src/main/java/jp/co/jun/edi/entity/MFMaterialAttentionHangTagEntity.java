...
/**
 * The persistent class for the m_f_material_attention_hang_tag database table.
 *
 */
@Entity
@Table(name = "m_f_material_attention_hang_tag")
@EntityListeners(AuditingEntityListener.class)
@Data
@EqualsAndHashCode(callSuper = true)
public class MFMaterialAttentionHangTagEntity extends GenericEntity {
