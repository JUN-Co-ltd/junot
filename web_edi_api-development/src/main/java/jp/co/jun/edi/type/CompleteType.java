...
public enum CompleteType {
     ...
     * @param value value
     */
    CompleteType(final String value) {
        this.value = value;
    }
     ...
     */
    public static Optional<CompleteType> findByValue(final String value) {
     ...
     * @return value
     */
    public static String convertToValue(final CompleteType type) {
     ...
     * @return type
     */
    public static CompleteType convertToType(final String value) {
     ...
     */
    @JsonCreator
    public static CompleteType convertToJson(final String value) {
