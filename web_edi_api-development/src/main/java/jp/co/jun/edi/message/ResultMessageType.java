...
public enum ResultMessageType {
    ...
    ERROR("error"),
    /** message type is <code>fatal</code>. */
    FATAL("fatal");
     ...
     * @param value value
     */
    ResultMessageType(final String value) {
        this.value = value;
    }
     ...
     */
    public static Optional<ResultMessageType> findByValue(final String value) {
     ...
     * @return value
     */
    public static String convertToValue(final ResultMessageType type) {
     ...
     * @return type
     */
    public static ResultMessageType convertToType(final String value) {
     ...
     */
    @JsonCreator
    public static ResultMessageType convertToJson(final String value) {
