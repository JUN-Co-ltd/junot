...
public enum MMailStatusType {
     ...
     * @param value value
     */
    MMailStatusType(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<MMailStatusType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final MMailStatusType type) {
     ...
     * @return type
     */
    public static MMailStatusType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static MMailStatusType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
