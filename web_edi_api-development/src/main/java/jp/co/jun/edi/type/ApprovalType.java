...
public enum ApprovalType {
     ...
     * @param value value
     */
    ApprovalType(final String value) {
        this.value = value;
    }
     ...
     */
    public static Optional<ApprovalType> findByValue(final String value) {
     ...
     * @return value
     */
    public static String convertToValue(final ApprovalType type) {
     ...
     * @return type
     */
    public static ApprovalType convertToType(final String value) {
     ...
     */
    @JsonCreator
    public static ApprovalType convertToJson(final String value) {
