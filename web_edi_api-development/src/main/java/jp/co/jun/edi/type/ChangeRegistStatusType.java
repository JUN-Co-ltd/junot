 ...
 * 登録ステータス変更区分.
 */
public enum ChangeRegistStatusType {
    /** 商品登録. */
    ITEM(0),
    /** 品番登録. */
    PART(1);
     ...
     * @param value value
     */
    ChangeRegistStatusType(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<ChangeRegistStatusType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final ChangeRegistStatusType type) {
     ...
     * @return type
     */
    public static ChangeRegistStatusType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static ChangeRegistStatusType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
