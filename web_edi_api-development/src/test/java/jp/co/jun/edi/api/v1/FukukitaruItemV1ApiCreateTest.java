...
@Transactional
public class FukukitaruItemV1ApiCreateTest {
    // モックサーバー
    @Autowired
    ...
    public void test_create_success() throws Exception {
        ...
        final MvcResult actual = mockServer
                .perform(MockMvcRequestBuilders.post("/api/v1/fukukitaru/items")
    ...
    private FukukitaruItemModel createFukukitaruItemModel() {
        ...
        model.setListItemAttentionAppendicesTerm(new ArrayList<FukukitaruItemAttentionAppendicesTermModel>() {
...

            {
                ...
                submodel.setId(null);
                submodel.setColorCode("00");
                submodel.setAppendicesTermId(BigInteger.valueOf(1));
        ...
        model.setListItemWashAppendicesTerm(new ArrayList<FukukitaruItemWashAppendicesTermModel>() {
...

            {
                ...
                submodel.setId(null);
                submodel.setColorCode("00");
                submodel.setAppendicesTermId(BigInteger.valueOf(2));
        ...
        model.setListItemWashPattern(new ArrayList<FukukitaruItemWashPatternModel>() {
...

            {
                ...
                submodel.setId(null);
                submodel.setColorCode("00");
                submodel.setWashPatternId(BigInteger.valueOf(3));

                add(submodel);
            }
        });
        // サスティナブルマーク印字0：印字しない,1：印字する.
        model.setPrintSustainableMark(BooleanType.TRUE);
        return model;
