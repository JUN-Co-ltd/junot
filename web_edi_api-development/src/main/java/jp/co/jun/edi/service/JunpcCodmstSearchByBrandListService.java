...
/**
 * 発注生産システムのコードマスタから、ブランドコードを指定して検索するService.
 */
@Service
public class JunpcCodmstSearchByBrandListService extends GenericMCodmstListService {
    @Autowired
    ...
    protected Page<MCodmstEntity> find(final JunpcCodmstListServiceParameter serviceParameter) {
        ...
        return mCodmstRepository.findByTblidAndCode1OrderByCode1Code2(
