...
public enum ArrivalType {
     ...
     */
    public static Optional<ArrivalType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final ArrivalType type) {
     ...
     * @return type
     */
    public static ArrivalType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static ArrivalType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
