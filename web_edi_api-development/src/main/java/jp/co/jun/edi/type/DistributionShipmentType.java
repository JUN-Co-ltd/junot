 ...
 * 配分出荷指示区分の定義.
 */
public enum DistributionShipmentType {
    /** 出荷指示. */
    DISTRIBUTION(1);
     ...
     * @param value value
     */
    DistributionShipmentType(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<DistributionShipmentType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final DistributionShipmentType type) {
     ...
     * @return type
     */
    public static DistributionShipmentType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static DistributionShipmentType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
