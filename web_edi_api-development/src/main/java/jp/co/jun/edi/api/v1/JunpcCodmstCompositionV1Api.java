...
/**
 * 発注生産システムのコードマスタから組成情報を取得するAPI.
 */
@RestController
@RequestMapping("/api/v1/junpc/codmst/compositions")
public class JunpcCodmstCompositionV1Api extends GenericJunpcCodmstV1Api {
    @Autowired
    private JunpcCodmstSearchByTblIdListService listService;

    /**
     * 発注生産システムのコードマスタから組成情報を一覧で取得する.
     *
    ...
    protected MCodmstTblIdType getTblId() {
        return MCodmstTblIdType.COMPOSITION;
    }
