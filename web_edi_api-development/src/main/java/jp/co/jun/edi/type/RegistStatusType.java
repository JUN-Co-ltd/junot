...
public enum RegistStatusType {
     ...
     * @param value value
     */
    RegistStatusType(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<RegistStatusType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final RegistStatusType type) {
     ...
     * @return type
     */
    public static RegistStatusType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static RegistStatusType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
