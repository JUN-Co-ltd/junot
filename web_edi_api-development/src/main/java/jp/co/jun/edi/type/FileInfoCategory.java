...
public enum FileInfoCategory {
     ...
     * @param value value
     */
    FileInfoCategory(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<FileInfoCategory> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final FileInfoCategory type) {
     ...
     * @return type
     */
    public static FileInfoCategory convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static FileInfoCategory convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
