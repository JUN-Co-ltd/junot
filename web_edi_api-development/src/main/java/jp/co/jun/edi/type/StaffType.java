...
public enum StaffType {
     ...
     */
    public static Optional<StaffType> findByValue(final Integer value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final StaffType type) {
     ...
     * @return type
     */
    public static StaffType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static StaffType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
