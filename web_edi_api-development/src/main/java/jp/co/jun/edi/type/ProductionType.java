...
public enum ProductionType {
     ...
     * @param value value
     */
    ProductionType(final String value) {
        this.value = value;
    }
     ...
     */
    public static Optional<ProductionType> findByValue(final String value) {
     ...
     * @return value
     */
    public static String convertToValue(final ProductionType type) {
     ...
     * @return type
     */
    public static ProductionType convertToType(final String value) {
     ...
     */
    @JsonCreator
    public static ProductionType convertToJson(final String value) {
