 ...
 * 出荷区分の定義.
 */
public enum ShippingCategoryType {

    /** 商品別配分. */
    ALLOCATION_PRODUCT(1),
     ...
     * @param value value
     */
    ShippingCategoryType(final int value) {
        this.value = value;
    }
     ...
     */
    public static Optional<ShippingCategoryType> findByValue(final int value) {
     ...
     * @return value
     */
    public static Integer convertToValue(final ShippingCategoryType type) {
     ...
     * @return type
     */
    public static ShippingCategoryType convertToType(final Integer value) {
     ...
     */
    @JsonCreator
    public static ShippingCategoryType convertToJson(final String value) {
        if (Objects.isNull(value)) {
            return null;
        }
